...
export function behavioralAnalysis(req: Request, res: Response, next: NextFunction) {
  ...
  // Be more lenient with 'unknown' IPs in development
  ...
  // Block if anomaly score is too high (unless in development with unknown IP)
  if (behavior.anomalyScore > 80 && !shouldSkipBlocking) {
